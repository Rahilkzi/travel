			...
			?>
				...
				<div class="col-sm-12">
					...
					<?php elseif ($mode == "package"): ?>
						...
						<div class="col-sm-12 bookingPackage">
					
							<?php
							$packageID = $_POST["packageIDHidden"];

							$packageSQL = "SELECT * FROM `packages` WHERE packageID='$packageID'";
							$packageQuery = $conn->query($packageSQL);
							$row = $packageQuery->fetch_assoc();
							?>
					
							<div class="col-sm-7"> <!-- package summary container -->
					
								<div class="col-sm-12">
					
									<div class="boxLeftPackage">
					
										<div class="col-sm-12 packageMode">Booking Summary</div>
					
										<div class="col-sm-12 packageName">
											<strong>Package:</strong> <span class="nameText">
												<?php echo $row["packageName"] . ' - ' . $row["packageDestination"]; ?>
											</span>
										</div>
					
										<div class="col-sm-6 borderRight">
											<div class="duration"><?php echo $row["packageDays"] . " Days / " . $row["packageNights"] . " Nights"; ?>
											</div>
											<div class="durationSubscript">Duration</div>
										</div>
					
										<div class="col-sm-6">
											<div class="departureDate"><?php echo date("d-m-Y"); ?></div>
											<div class="departureSubscript">Booking Date</div>
										</div>
							...
							<div class="col-sm-5"> <!-- fare container -->
								...
								<div class="col-sm-12">
									...
									<div class="boxRightPackage">
					
										<div class="col-sm-12 fareSummary">Payment Summary</div>
					
										<div class="col-sm-8">
											<div class="heading">Package Price</div>
											<div class="heading">Convenience Fee</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="priceTotal"><span class="sansSerif">₹ </span>
												<?php echo ($row["packageOffer"] ? $row["packageDiscountPrice"] : $row["packagePrice"]) + 250; ?>
											</div>
										</div>
										...
										<form action="payment.php" method="POST">
											...
											<?php
											$totalFare = ($row["packageOffer"] ? $row["packageDiscountPrice"] : $row["packagePrice"]) + 250;
											?>
