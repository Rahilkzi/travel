...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2025 at 12:24 PM
...
(44, ', , ', '04-02-2025', 'admin', 'yes'),
(45, ', , ', '04-02-2025', 'admin', 'yes'),
(46, ', , ', '04-02-2025', 'admin', 'no'),
(47, ', , ', '04-02-2025', 'admin', 'no'),
(48, ', , ', '04-02-2025', 'admin', 'no'),
(49, 'Hotel Mulberry, Sarat Bose Road, Kolkata', '13-02-2025', 'tassu@21', 'yes');
...
INSERT INTO `packagebookings` (`bookingID`, `packageName`, `date`, `username`, `cancelled`, `created_at`) VALUES
(1, '', '0000-00-00', 'admin', 'no', '2025-02-04 05:32:05'),
(2, '', '0000-00-00', 'admin', 'no', '2025-02-04 05:36:28'),
(3, '', '0000-00-00', 'admin', 'no', '2025-02-04 05:37:47'),
(4, '', '0000-00-00', 'admin', 'no', '2025-02-04 05:38:38'),
(5, 'manali winter', '0000-00-00', 'admin', 'no', '2025-02-04 05:42:43'),
(6, 'manali winter', '0000-00-00', 'admin', 'no', '2025-02-04 05:42:56'),
(7, 'manali winter', '0000-00-00', 'admin', 'no', '2025-02-04 05:47:43'),
(8, 'manali winter', '0000-00-00', 'admin', 'no', '2025-02-04 05:48:03'),
(9, 'manali winter', '0000-00-00', 'test', 'no', '2025-02-04 05:56:42'),
(10, 'Shimla Delight Tour', '0000-00-00', 'tassu@21', 'no', '2025-02-10 05:35:12');
...
CREATE TABLE `packages` (
  ...
  `packageDestination` varchar(255) NOT NULL,
  `packageDays` int(11) NOT NULL,
  `packageNights` int(11) NOT NULL,
  `packageAccommodation` varchar(255) NOT NULL,
  `packageTransportation` varchar(255) NOT NULL,
  `packageMeals` varchar(255) NOT NULL,
  `packageActivities` text NOT NULL,
  `packagePrice` decimal(10,2) NOT NULL,
  `packageDiscountPrice` decimal(10,2) DEFAULT 0.00,
  `packageOffer` tinyint(1) DEFAULT 0,
  `packageRating` decimal(3,2) DEFAULT 0.00,
  `packageTotalRatings` int(11) DEFAULT 0,
  `packageImages` text DEFAULT NULL,
...
INSERT INTO `packages` (`packageID`, `packageName`, `packageDescription`, `packageDestination`, `packageDays`, `packageNights`, `packageAccommodation`, `packageTransportation`, `packageMeals`, `packageActivities`, `packagePrice`, `packageDiscountPrice`, `packageOffer`, `packageRating`, `packageTotalRatings`, `packageImages`, `createdAt`, `updatedAt`, `date`) VALUES
(14, 'Manali Adventure Retreat', 'Experience the beauty of Manali with breathtaking landscapes, adventure sports, and local sightseeing.', 'Manali, Himachal Pradesh', 4, 3, 'JHG Grand Hotel', 'Luxury Bus & Private Cab', 'Breakfast & Dinner Included', ' Sightseeing, Trekking, Local Shopping, Snow Sports', '14999.00', '12999.00', 0, '0.00', 0, 'uploads/manali.jpg', '2025-02-14 04:10:43', '2025-02-14 04:10:43', NULL),
(15, 'Goa Beach Escape', ' Relax on the golden beaches of Goa, explore Portuguese heritage, and enjoy water sports.', 'goa', 5, 4, 'Blue Lagoon Resort', 'Flight & Private Cab', 'Breakfast Included', 'Beach Hopping, Water Sports, Nightlife, Shopping', '18999.00', '16499.00', 0, '0.00', 0, 'uploads/goa.jpg', '2025-02-14 04:49:23', '2025-02-14 04:49:23', NULL),
(16, 'Kashmir Paradise Tour', 'Discover the serene beauty of Kashmir with scenic valleys, houseboats, and breathtaking gardens.', 'Srinagar, Gulmarg & Pahalgam', 6, 5, 'Royal Houseboat & Mountain Resort', 'Train & Private Cab', 'Breakfast & Dinner Included', 'Shikara Ride, Gondola Ride, Sightseeing, Shopping', '24999.00', '21999.00', 0, '0.00', 0, 'uploads/kashmir.jpg', '2025-02-14 04:52:14', '2025-02-14 04:52:14', NULL),
(17, ' Shimla & Kufri Snow Delight', 'Experience the charm of colonial architecture and snow-covered peaks.', 'Shimla & Kufri', 4, 3, '3-Star Hotel', 'Volvo Bus & Private Cab', 'Breakfast & Dinner Included', 'Snow Sports, Sightseeing, Shopping at Mall Road', '13999.00', '11999.00', 0, '0.00', 0, 'uploads/shimla.jpg', '2025-02-14 05:01:27', '2025-02-14 05:01:27', NULL),
(18, ' Meghalaya & Kaziranga Wilderness', 'Explore the \"Abode of Clouds\" with mesmerizing waterfalls and a wildlife safari.', 'Shillong, Cherrapunji & Kaziranga National Park', 7, 6, 'Eco-Resort & Jungle Lodge', 'Flight & Private Cab', 'Breakfast & Dinner Included', 'Elephant Safari, Cave Exploration, Living Root Bridge Trek', '27999.00', '23999.00', 0, '0.00', 0, 'uploads/meghalaya.jpg', '2025-02-14 05:09:49', '2025-02-14 05:09:49', NULL),
(19, 'Darjeeling & Sikkim Escape', ' Enjoy the scenic beauty of the Himalayas, tea gardens, and Buddhist monasteries.', 'Darjeeling & Gangtok', 6, 5, 'Mountain View Hotel', ' Flight & Private Cab', 'Breakfast & Dinner Included', 'Toy Train Ride, Tsomgo Lake Visit, Tea Garden Tour, Ropeway Ride', '24999.00', '21499.00', 0, '0.00', 0, 'uploads/sikkim.jpg', '2025-02-14 05:19:40', '2025-02-14 05:19:40', NULL),
(20, ' Andaman Island Getaway', ' Explore pristine beaches, turquoise waters, and rich marine life in Andaman.', 'Port Blair, Havelock & Neil Island', 5, 4, ' Beach Resort', 'Flight & Private Cab', 'Breakfast & Dinner Included', ' Scuba Diving, Snorkeling, Beach Walks, Light & Sound Show at Cellular Jail', '28999.00', '24999.00', 0, '0.00', 0, 'uploads/andaman.jpg', '2025-02-14 05:27:41', '2025-02-14 05:27:41', NULL),
(21, 'Maharashtra Konkan Coast Tour', 'Enjoy the pristine beaches, forts, and delicious seafood along the Konkan coast.', 'Alibaug, Ratnagiri, Ganpatipule', 4, 3, ' Beachside Resort', 'Private Cab', 'Breakfast & Dinner Included', 'Beach Walks, Fort Exploration, Dolphin Safari', '15999.00', '13999.00', 0, '0.00', 0, 'uploads/maharashtra.jpg', '2025-02-14 05:36:56', '2025-02-14 05:36:56', NULL);
...
(13, 'tassu@21', '14-02-2025', 'no', 'Dimapur', 'Guwahati', 3);
...
(15960, 'NFR', 15959, 'KAMRUP EXPRESS', 'Dimapur', 'Guwahati', 'DMV', 'GHY', '01:50', '7:30', '2', '9', '5h 40m', '2AC,3AC,SL', 0, 15, 2, 10, 0, 1, '3000', '2000', '1400', '1000', '0', '500', 'Mo,Tu,We,Th,Fr,Sa,Su', 3),
...
(18, 'rahilkazi', 'rahilkazi66@gmail.com', '09067694385', 'test', '$2a$08$v7dEmlIjsIWUtgS3hEa9tOKQW2Cl9IAV12yztLF0Yc2l1lpEVPu9u', '788/304, al-ahmed residency, mapari mohalla', 'kjhg', 'Rajapur (M Cl)', 'Maharashtra', 'Tuesday 4th of February 2025 at 11:20:20 AM'),
(19, 'tassu', 'tassu@gmail.com', '7020335853', 'tassu@21', '$2a$08$X3ZGB0fpTjxiFgNK6pPVKO9vQZkw257H3gnEkkOJcXy98oXnn8.i6', 'pune,Maharashtra', 'pune', 'pune', 'maharashtra', 'Monday 10th of February 2025 at 10:06:16 AM'),
(20, 'tass', 'tassu@gmail.com', '7020335853', 'tassu@21', 'tassu', 'pune,Maharashtra', 'pune', 'pune', 'maharashtra', '2025-02-12');
...
ALTER TABLE `package_ratings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_rating` (`packageID`,`username`);
