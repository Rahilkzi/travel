	...
	justify-content: center;">
			<div class="col-lg-4">
				<form method="post" action="">
					...
					<input type="number" name="hotelID" class="form-control" placeholder="Hotel ID /Automatic Number Genrates"
						value="<?php echo ($hotelID); ?>" disabled>

					<div class="form-group row">
						<div class="col-xs-6">
							<h4>Hotel Name</h4>
							<input type="text" name="hotelName" class="form-control" placeholder="Enter hotel name"
								value="<?php echo ($hotelName); ?>" required>
						</div>
						...
						<div class="col-xs-6">
							<h4>Locality</h4>
							<input type="text" name="locality" class="form-control" placeholder="Enter locality"
								value="<?php echo ($locality); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Stars</h4>
							<input type="int" name="stars" class="form-control" placeholder="Enter no. of stars"
								value="<?php echo ($stars); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Rating</h4>
							<input type="text" class="form-control" name="rating" placeholder="Give rating"
								value="<?php echo ($rating); ?>" required>
						</div>


						<div class="col-xs-6">
							<h4>Description</h4>
							<input type="text" name="hotelDesc" class="form-control" placeholder="Enter description"
								value="<?php echo ($hotelDesc); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Check In</h4>
							<input type="time" name="checkIn" class="form-control" placeholder="Enter checkin time"
								value="<?php echo ($checkIn); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Check Out</h4>
							<input type="time" name="checkOut" class="form-control" placeholder="Enter checkOut time"
						...
						<div class="col-xs-6">
							...
							<input type="number" name="roomsAvailable" class="form-control" placeholder="Enter no. of available rooms"
								value="<?php echo ($roomsAvailable); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Wifi</h4>
							<input type="text" name="wifi" class="form-control" placeholder="Enter yes or no"
								value="<?php echo ($wifi); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Swimming Pool</h4>
							<input type="text" name="swimmingPool" class="form-control" placeholder="Enter yes or no"
								value="<?php echo ($swimmingPool); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Parking</41>
								<input type="text" name="parking" class="form-control" placeholder="Enter yes or no"
									value="<?php echo ($parking); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Restaurant</h4>
							<input type="text" name="restaurant" class="form-control" placeholder="Enter yes or no"
								value="<?php echo ($restaurant); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Laundry</h4>
							<input type="text" name="laundry" class="form-control" placeholder="Enter yes or no"
								value="<?php echo ($laundry); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Cafe</h4>
							<input type="text" name="cafe" class="form-control" placeholder="Enter yes or no"
								value="<?php echo ($cafe); ?>" required>
						</div>

						<div class="col-xs-6">
							<h4>Image</h4>
							<input type="text" name="mainImage" class="form-control" placeholder="Enter link of image"
								value="<?php echo ($mainImage); ?>" required>
						</div>
					</div>
