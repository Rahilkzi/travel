...
{
    $info = getData();
    $search_query="SELECT * FROM packagebookings WHERE bookingID = '$info[0]'";
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="nav">
                    <ul class="nav navbar-nav" style="float:right">
                        ...
                        <li><a href="packages_add.php">ADD PACKAGES</a></li>
                        <li><a href="packagesbookings_view.php">PACKAGES BOOKINGS</a></li>
    ...
    <div class="col-lg-8">
        ...
        <div>
            ...
            $sql = "SELECT bookingID,packageName,date,username,cancelled FROM packagebookings";
